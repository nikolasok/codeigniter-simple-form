...
<div class="main col-md-8 offset-md-2 col-sd-10 offset-sd-1 ">
    <div id="content">
        <h1 id="form_head">Добавить город</h1><br/>
        ...
        <div id="form_input" class="col-md-12">
            ...
            <? echo form_submit('submit', 'Добавить', "class='sendreq btn btn-primary col-md-3 offset-md-3 col-lg-3 offset-lg-3 col-xl-2 offset-xl-3'"); ?>
